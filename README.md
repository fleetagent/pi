...
* **[@fleetagent/pi-agent-core](packages/agent)**: Agent runtime with tool calling and state management
* **[@fleetagent/pi-ai](packages/ai)**: Unified multi-provider LLM API (OpenAI, Anthropic, Google, …)
...
| Package | Description |
|---------|-------------|
| **[@fleetagent/pi-ai](packages/ai)** | Unified multi-provider LLM API (OpenAI, Anthropic, Google, etc.) |
| **[@fleetagent/pi-agent-core](packages/agent)** | Agent runtime with tool calling and state management |
| **[@fleetagent/pi-coding-agent](packages/coding-agent)** | Interactive coding agent CLI |

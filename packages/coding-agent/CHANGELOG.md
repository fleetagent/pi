...
* **ai:** support long cache retention compat ([4cd4cfd](https://github.com/fleetagent/pi/commit/4cd4cfd98ebf57e391b3848e1b66c0d0d41df38a)), closes [#3543](https://github.com/fleetagent/pi/issues/3543)
...
* The following workspace dependencies were updated
  * dependencies
    * @fleetagent/pi-agent-core bumped from ^0.0.1 to ^1.0.0
    * @fleetagent/pi-ai bumped from ^0.0.1 to ^1.0.0
    * @fleetagent/pi-tui bumped from ^0.0.1 to ^1.0.0

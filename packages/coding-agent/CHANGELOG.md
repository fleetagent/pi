...
* The following workspace dependencies were updated
  * dependencies
    * @fleetagent/pi-agent-core bumped from ^0.2.8 to ^0.2.9
    * @fleetagent/pi-ai bumped from ^0.2.8 to ^0.2.9
    * @fleetagent/pi-tui bumped from ^0.2.8 to ^0.2.9
...
### Fixed
- Reset the compression detector's percentage trigger against post-compression context usage, instead of zero, so compression does not cause an immediate redundant check.
...
* The following workspace dependencies were updated
  * dependencies
    * @fleetagent/pi-agent-core bumped from ^0.1.9 to ^0.2.0
    * @fleetagent/pi-ai bumped from ^0.1.9 to ^0.2.0
    * @fleetagent/pi-tui bumped from ^0.1.9 to ^0.2.0
...
* **coding-agent:** sync installer lock for release ([8849291](https://github.com/fleetagent/pi/commit/8849291d6714a443a4afda60632577a180ec9224))
...
* The following workspace dependencies were updated
  * dependencies
    * @fleetagent/pi-agent-core bumped from ^0.1.5 to ^0.1.6
    * @fleetagent/pi-ai bumped from ^0.1.5 to ^0.1.6
    * @fleetagent/pi-tui bumped from ^0.1.5 to ^0.1.6
...
- Added session-scoped RPC skill and rule registration.
...
* The following workspace dependencies were updated
  * dependencies
    * @fleetagent/pi-agent-core bumped from ^0.0.11 to ^0.0.12
    * @fleetagent/pi-ai bumped from ^0.0.11 to ^0.0.12
    * @fleetagent/pi-tui bumped from ^0.0.11 to ^0.0.12
...
* The following workspace dependencies were updated
  * dependencies
    * @fleetagent/pi-agent-core bumped from ^0.0.6 to ^0.0.7
    * @fleetagent/pi-ai bumped from ^0.0.6 to ^0.0.7
    * @fleetagent/pi-tui bumped from ^0.0.6 to ^0.0.7
...
* The following workspace dependencies were updated
  * dependencies
    * @fleetagent/pi-agent-core bumped from ^0.0.1 to ^0.0.2
    * @fleetagent/pi-ai bumped from ^0.0.1 to ^0.0.2
    * @fleetagent/pi-tui bumped from ^0.0.1 to ^0.0.2
...
* **ai:** users who previously set XIAOMI_API_KEY against the Token Plan AMS endpoint must move to xiaomi-token-plan-ams and set XIAOMI_TOKEN_PLAN_AMS_API_KEY. This also resolves the 401 reported by on #4005, where a platform.xiaomimimo.com key fails against the Token Plan endpoint.
* **ai:** users who previously set XIAOMI_API_KEY against the Token Plan AMS endpoint must move to xiaomi-token-plan-ams and set XIAOMI_TOKEN_PLAN_AMS_API_KEY. This also resolves the 401 reported by on #4005, where a platform.xiaomimimo.com key fails against the Token Plan endpoint.
...
* **ai:** add cached codex websocket transport ([4745a95](https://github.com/fleetagent/pi/commit/4745a9589883fb8200981ddfecb94a593d6e95a2))
* **ai:** add Cloudflare AI Gateway as a provider ([#3856](https://github.com/fleetagent/pi/issues/3856)) ([24fb6b8](https://github.com/fleetagent/pi/commit/24fb6b833b7263df3d08889cc492b03d46d3779b))
* **ai:** add Cloudflare Workers AI as a provider ([#3851](https://github.com/fleetagent/pi/issues/3851)) ([d6e08b3](https://github.com/fleetagent/pi/commit/d6e08b3da011a871088963fb7baffec730687eab))
* **ai:** add Moonshot AI provider model support ([7dc1bed](https://github.com/fleetagent/pi/commit/7dc1bed4785694f6c6d1d8e9c63e115802aed184))
* **ai:** add Together AI provider ([7adb8e7](https://github.com/fleetagent/pi/commit/7adb8e7634ccaee0510698ddf7df5362667db14c))
* **ai:** add Xiaomi MiMo provider ([#4005](https://github.com/fleetagent/pi/issues/4005)) ([a446226](https://github.com/fleetagent/pi/commit/a44622670f8626b84f42885942c9ca340f823b5a))
* **ai:** refactor device code login for copilot ([11e868b](https://github.com/fleetagent/pi/commit/11e868b790b08b1be0a58695a611e2eb5d23ce2e))
* **ai:** refactor device code login for copilot ([c554364](https://github.com/fleetagent/pi/commit/c554364c2a82915c8c2b991507f252fc024a2217))
* **ai:** switch xiaomi default to api billing, add per-region token plan providers ([#4112](https://github.com/fleetagent/pi/issues/4112)) ([b326bf1](https://github.com/fleetagent/pi/commit/b326bf1a3ae64efe388379e82686b8c6f7d9d068)), closes [#4082](https://github.com/fleetagent/pi/issues/4082)
* **ai:** switch xiaomi default to api billing, add per-region token plan providers ([#4112](https://github.com/fleetagent/pi/issues/4112)) ([693888a](https://github.com/fleetagent/pi/commit/693888ac47988419061d56712576c7fac04446c8)), closes [#4082](https://github.com/fleetagent/pi/issues/4082)
* **coding-agent:** Add built-in update command ([#3680](https://github.com/fleetagent/pi/issues/3680)) ([dcf2651](https://github.com/fleetagent/pi/commit/dcf2651631fd19127c40c5bd4f2c51e28083e64d))
* **coding-agent:** add composable editor factory access ([d698647](https://github.com/fleetagent/pi/commit/d698647b128b71ebe7fa648e173d719dc4a8abf7)), closes [#3935](https://github.com/fleetagent/pi/issues/3935)
* **coding-agent:** add provider display names ([cf5ec23](https://github.com/fleetagent/pi/commit/cf5ec232400bb0e270abe2441c65c0285dea3c77)), closes [#3956](https://github.com/fleetagent/pi/issues/3956)
* **coding-agent:** add remote session persistence ([c6dbcbb](https://github.com/fleetagent/pi/commit/c6dbcbb9a85f6adb2d3402a4dfcec3446778615b))
* **coding-agent:** add warnings.anthropicExtraUsage opt-out ([aefb0fe](https://github.com/fleetagent/pi/commit/aefb0fedfecaef377fc47eafc1455f0c650c3e4a)), closes [#3808](https://github.com/fleetagent/pi/issues/3808)
* **coding-agent:** allow comments and trailing commas in models.json ([#4162](https://github.com/fleetagent/pi/issues/4162)) ([bb25a39](https://github.com/fleetagent/pi/commit/bb25a3944c0a8747c99d4360d71eb659554d65a1))
* **coding-agent:** allow hiding working loader ([6580dae](https://github.com/fleetagent/pi/commit/6580dae40081157a18ba5b596231e437ea2ae947)), closes [#3674](https://github.com/fleetagent/pi/issues/3674)
* **coding-agent:** allow message_end replacements ([40c6eab](https://github.com/fleetagent/pi/commit/40c6eabb8f9b34ca0ffb652d6e3a7929b5e2eee5)), closes [#3982](https://github.com/fleetagent/pi/issues/3982)
* **coding-agent:** expose edit tool unified patch ([60a55a2](https://github.com/fleetagent/pi/commit/60a55a23991a1033243cb6f6d6e29670b9964c11)), closes [#4821](https://github.com/fleetagent/pi/issues/4821)
* **coding-agent:** improve terminal theme detection ([f10cf57](https://github.com/fleetagent/pi/commit/f10cf57e96addf6ba8e2ed3e859e68a911923756))
* **coding-agent:** show update notes ([#4724](https://github.com/fleetagent/pi/issues/4724)) ([f4f0ac7](https://github.com/fleetagent/pi/commit/f4f0ac7adaef08f2ec750ccb4c76cd90e93922a7))
* **coding-agent:** support renamed self-update package ([5e1e4c3](https://github.com/fleetagent/pi/commit/5e1e4c3c88329fcd34366dc9cda6d3debeacb33f))
* **coding-agent:** support session dir env ([8191d59](https://github.com/fleetagent/pi/commit/8191d59c170c9bb336a82771e1826d25bb7ec1e0)), closes [#4027](https://github.com/fleetagent/pi/issues/4027)
* image content ([c3c1073](https://github.com/fleetagent/pi/commit/c3c10737d86f76ec61fc46ccc957eda883010d6d))
* **login:** More consistent styling ([d4d3c2f](https://github.com/fleetagent/pi/commit/d4d3c2fd3917e1c0ba539c5c994ec5f4571edc61))
* **oauth:** support interactive login selection ([#4190](https://github.com/fleetagent/pi/issues/4190)) ([b5755fd](https://github.com/fleetagent/pi/commit/b5755fd27d115910249e8e29d48685569bfc8498))
* **read:** compact resource read rendering ([8940c02](https://github.com/fleetagent/pi/commit/8940c023025a93e6fe52d48ece6945d1a9594533))
* **read:** compact resource read rendering ([588639f](https://github.com/fleetagent/pi/commit/588639fa97567a661dac876dc2b1970c8a3497ae))
* **ui:** Lower /scoped-models height to same as /models ([27c05b7](https://github.com/fleetagent/pi/commit/27c05b7faaa024173b31b95cc410c120403d3fce))
* Update check against pi.dev ([#3877](https://github.com/fleetagent/pi/issues/3877)) ([c745efc](https://github.com/fleetagent/pi/commit/c745efc0d023f9865187f0241964a4b40bb43dbc))


### Bug Fixes

* /model cancellation ([40edf7e](https://github.com/fleetagent/pi/commit/40edf7ee06dc581f110392242eda24623a44a59f))
...
* **agent:** support fdfind as fd fallback ([3edb8b5](https://github.com/fleetagent/pi/commit/3edb8b5cb716ec4fec812a7022c559af83ad3121))
* **ai,coding-agent:** expose provider timeout/retry controls closes [#3627](https://github.com/fleetagent/pi/issues/3627) ([c067504](https://github.com/fleetagent/pi/commit/c06750410a590fb53f01056c4f7f145d8a65c59c))
* **ai,coding-agent:** omit undefined provider request options closes [#3627](https://github.com/fleetagent/pi/issues/3627) ([c1b62ae](https://github.com/fleetagent/pi/commit/c1b62ae7fe70db757a349104c60c97b4a1a4eee8))
* **ai:** fall back from codex websocket to sse ([#4133](https://github.com/fleetagent/pi/issues/4133)) ([ce377fc](https://github.com/fleetagent/pi/commit/ce377fc4a1ffeb36e4c1027cc0c615a073685a76))
* **ai:** fall back from codex websocket to sse ([#4133](https://github.com/fleetagent/pi/issues/4133)) ([370fdae](https://github.com/fleetagent/pi/commit/370fdae6fa23881b044efbab571fb7bf6267ed6e))
* **ai:** finalize cloudflare gateway provider support ([a45577b](https://github.com/fleetagent/pi/commit/a45577bd0020a89ba6f14d744b287b5a998b02b7))
...
* **ai:** use Xiaomi Token Plan Anthropic endpoint ([c0e0469](https://github.com/fleetagent/pi/commit/c0e046990e0b8bada9f3f2c1b665436820589d9f)), closes [#3912](https://github.com/fleetagent/pi/issues/3912)
* align theme truecolor detection ([dafcf61](https://github.com/fleetagent/pi/commit/dafcf61a34f74ba1ce90ed4f610121ffc68c755f))
* **ci:** repair failing test expectations ([e1433cf](https://github.com/fleetagent/pi/commit/e1433cf65b0a7a0d769bf6017b554a300c41fe1a))
* **ci:** repair failing test expectations ([b9efafc](https://github.com/fleetagent/pi/commit/b9efafc5351a746108adb9b135564c574f8f8cfd))
* **coding-agent,ai:** fallback to /proc/self/environ in Bun sandbox ([#3801](https://github.com/fleetagent/pi/issues/3801)) ([5b8deef](https://github.com/fleetagent/pi/commit/5b8deef2f9d255aa682ed99f1b8f100b6e11340c))
* **coding-agent:** align stripAnsi with strip-ansi ([8bf2bfa](https://github.com/fleetagent/pi/commit/8bf2bfab58679d4d719c9d97030c0409f59f27a8))
* **coding-agent:** align undici fetch globals ([0852303](https://github.com/fleetagent/pi/commit/085230373f585c08d32457f615d29b356348b586)), closes [#4650](https://github.com/fleetagent/pi/issues/4650) [#4652](https://github.com/fleetagent/pi/issues/4652) [#4653](https://github.com/fleetagent/pi/issues/4653)
* **coding-agent:** allow skill names to differ from directories ([5d31e70](https://github.com/fleetagent/pi/commit/5d31e70b8a23008a745aa0315eeb6226694d481f)), closes [#4534](https://github.com/fleetagent/pi/issues/4534)
* **coding-agent:** allow tool expansion during extension confirms ([d62c416](https://github.com/fleetagent/pi/commit/d62c416cfdf99ba407cd66b18abe35dd09ec4af9)), closes [#4429](https://github.com/fleetagent/pi/issues/4429)
* **coding-agent:** allow Windows pnpm self-update ([c651773](https://github.com/fleetagent/pi/commit/c65177370b6b97669844797c7ddc80dd042d702b)), closes [#4157](https://github.com/fleetagent/pi/issues/4157)
* **coding-agent:** avoid cmd.exe for git installs on windows closes [#3642](https://github.com/fleetagent/pi/issues/3642) ([7bd9f65](https://github.com/fleetagent/pi/commit/7bd9f6500db85a4f6b0e680c6676f2bace818c95))
* **coding-agent:** avoid duplicate bash truncation path ([7dad27e](https://github.com/fleetagent/pi/commit/7dad27e5f2eaa30f25992a6ae400519586e8b568)), closes [#4819](https://github.com/fleetagent/pi/issues/4819)
* **coding-agent:** avoid duplicate blocked edit output ([3ffc2b4](https://github.com/fleetagent/pi/commit/3ffc2b4306da6069dd6ec3007d3ad2410bdf8ff3)), closes [#3830](https://github.com/fleetagent/pi/issues/3830)
* **coding-agent:** avoid Windows self-update native locks ([89b64d9](https://github.com/fleetagent/pi/commit/89b64d9dd5411e40092d4417b8d77ce911092828)), closes [#4157](https://github.com/fleetagent/pi/issues/4157)
* **coding-agent:** cap resume session metadata loads ([758004d](https://github.com/fleetagent/pi/commit/758004d1bb1488998b3b752bfb039d517d9c2b16)), closes [#4583](https://github.com/fleetagent/pi/issues/4583) [#4591](https://github.com/fleetagent/pi/issues/4591)
* **coding-agent:** clarify pi docs path resolution closes [#4752](https://github.com/fleetagent/pi/issues/4752) ([48b6510](https://github.com/fleetagent/pi/commit/48b6510c18e3499d462ade5c656fc2db7cc8eaa9))
* **coding-agent:** Clean up Path Handling ([#4873](https://github.com/fleetagent/pi/issues/4873)) ([c100620](https://github.com/fleetagent/pi/commit/c100620bf447349ae7a4866bc1cb6757cc9f67c4))
* **coding-agent:** clear idle follow-up submissions ([39146f3](https://github.com/fleetagent/pi/commit/39146f3296bd57d99e9a59e6d94a4dcb12da6c1d)), closes [#3926](https://github.com/fleetagent/pi/issues/3926)
* **coding-agent:** clear tree navigation compaction state ([a363b66](https://github.com/fleetagent/pi/commit/a363b668ac930f11412de09450c847c1351c0d03)), closes [#3688](https://github.com/fleetagent/pi/issues/3688)
* **coding-agent:** close bash executor temp streams ([e4f847f](https://github.com/fleetagent/pi/commit/e4f847ff68ba877affb4148d30c9e8c8167ac33c)), closes [#3786](https://github.com/fleetagent/pi/issues/3786)
* **coding-agent:** close codex websocket sessions ([78c3cbe](https://github.com/fleetagent/pi/commit/78c3cbe0c39ea60e81bec83734f8529af30589fb)), closes [#4103](https://github.com/fleetagent/pi/issues/4103)
* **coding-agent:** close codex websocket sessions ([5fa277b](https://github.com/fleetagent/pi/commit/5fa277b320531f43a1378f357bac6143f99e77c6)), closes [#4103](https://github.com/fleetagent/pi/issues/4103)
* **coding-agent:** configure HTTP idle timeout ([#4759](https://github.com/fleetagent/pi/issues/4759)) ([849f9d9](https://github.com/fleetagent/pi/commit/849f9d9c5af90ec61371f97648ef40fd4a0a0479))
* **coding-agent:** correct bash truncation line count ([f953067](https://github.com/fleetagent/pi/commit/f953067814ceed5fc9366db577333c460c9c5e4f)), closes [#4818](https://github.com/fleetagent/pi/issues/4818)
* **coding-agent:** decouple codex session cleanup ([2342001](https://github.com/fleetagent/pi/commit/23420012abd670e7ff74dd47c8a81103ca97c0a9))
* **coding-agent:** dedupe symlinked resources ([#3818](https://github.com/fleetagent/pi/issues/3818)) ([10425ab](https://github.com/fleetagent/pi/commit/10425abb877f2ab5d0f5dbb0f887c9d362bb7e95))
* **coding-agent:** detect pnpm v11 self-update installs ([96cad24](https://github.com/fleetagent/pi/commit/96cad24a07ba41d51935b2400ed0303f1edec288)), closes [#4647](https://github.com/fleetagent/pi/issues/4647)
* **coding-agent:** detect renamed npm self updates ([dacb7ea](https://github.com/fleetagent/pi/commit/dacb7eaa90cf3f90c39db49cf4001190ffd9fd31))
* **coding-agent:** disable scripts during self-update ([a3ebcd2](https://github.com/fleetagent/pi/commit/a3ebcd2322be07187a69a188b6af21051d2a359a))
* **coding-agent:** disable undici body/headers idle timeouts on global dispatcher ([ea90a67](https://github.com/fleetagent/pi/commit/ea90a6783d281853d65c20aafc0b6ea268d5f3ca)), closes [#3715](https://github.com/fleetagent/pi/issues/3715)
* **coding-agent:** disable undici http2 ([967fb4d](https://github.com/fleetagent/pi/commit/967fb4d8b99cdb7cdd05fc597e88f16f67f64483))
* **coding-agent:** disambiguate resource paths ([3421726](https://github.com/fleetagent/pi/commit/3421726e8629d4cd344e75b94bdf9d7412dfddca))
* **coding-agent:** dispose SDK example sessions ([2b895e2](https://github.com/fleetagent/pi/commit/2b895e20cd5b65bb02ef58026f3eb981fd7d27ae))
* **coding-agent:** dispose SDK example sessions ([d68011d](https://github.com/fleetagent/pi/commit/d68011dab17f3a5e66b03ee1a1b82968ae9749f5))
* **coding-agent:** escape exported image data ([#3819](https://github.com/fleetagent/pi/issues/3819)) ([7617c1a](https://github.com/fleetagent/pi/commit/7617c1ad920b519893882801494e80ec88aa0fd3)), closes [#3811](https://github.com/fleetagent/pi/issues/3811)
* **coding-agent:** escape exported session metadata ([#3883](https://github.com/fleetagent/pi/issues/3883)) ([57787b6](https://github.com/fleetagent/pi/commit/57787b6557b9129189e0fe03bf47f9779938ed63))
* **coding-agent:** exit on lost terminal ([756b774](https://github.com/fleetagent/pi/commit/756b7749356f4b2e8a887668e30ad57df1761e76))
* **coding-agent:** fix packaged session selector import ([2c08775](https://github.com/fleetagent/pi/commit/2c08775ee718549328bae9a4bb8acf4e1bb5327d))
* **coding-agent:** fix Termux docs code fence ([3ca474b](https://github.com/fleetagent/pi/commit/3ca474b15b2df46cf61d5a1383a993f49b741b17)), closes [#4503](https://github.com/fleetagent/pi/issues/4503)
* **coding-agent:** fix Windows self-update ([9848b31](https://github.com/fleetagent/pi/commit/9848b3145a138d92b2461799f125f9558168ece4)), closes [#3857](https://github.com/fleetagent/pi/issues/3857)
* **coding-agent:** fix WSL clipboard image paste ([0b8452c](https://github.com/fleetagent/pi/commit/0b8452c32f1aed2c74aa447ae7028de4d926a033)), closes [#2469](https://github.com/fleetagent/pi/issues/2469)
* **coding-agent:** guard undici install under Bun ([936f55b](https://github.com/fleetagent/pi/commit/936f55ba9b7329bdce5209aafea3fba975708af7))
* **coding-agent:** guard undici install under Bun ([363214b](https://github.com/fleetagent/pi/commit/363214bd320ff4c7f52e74cd972300d4973e378f)), closes [#4657](https://github.com/fleetagent/pi/issues/4657)
* **coding-agent:** handle frontmatter prompts in print mode ([bac2df3](https://github.com/fleetagent/pi/commit/bac2df36b9c4b01c9b17426d149b7cdc81a7daa4)), closes [#4163](https://github.com/fleetagent/pi/issues/4163)
* **coding-agent:** harden clipboard copy ([1e33492](https://github.com/fleetagent/pi/commit/1e334925254b78a74100ec87f9c255cafb4bca99)), closes [#3639](https://github.com/fleetagent/pi/issues/3639)
* **coding-agent:** honor registered model base urls ([ddb8ed0](https://github.com/fleetagent/pi/commit/ddb8ed0c73a98e331ad142ac8d88505f5c0ca51b)), closes [#4063](https://github.com/fleetagent/pi/issues/4063)
* **coding-agent:** hyperlink update changelog closes [#4280](https://github.com/fleetagent/pi/issues/4280) ([defd703](https://github.com/fleetagent/pi/commit/defd7038ab73fd5a6aaee4b48cda7c2f99f28738))
* **coding-agent:** improve auth setup warnings ([bffb760](https://github.com/fleetagent/pi/commit/bffb760f4f1524b2131feb1499ee9245c17fdc22))
* **coding-agent:** improve subagent parallel summaries closes [#4710](https://github.com/fleetagent/pi/issues/4710) ([93ecdbe](https://github.com/fleetagent/pi/commit/93ecdbea3551d24e6ba375f82a1751eeedadb4a9))
* **coding-agent:** install npm packages in managed root closes [#4587](https://github.com/fleetagent/pi/issues/4587) ([6f93179](https://github.com/fleetagent/pi/commit/6f931797cae24ad9ea392d220c1f7c7f4585b50e))
* **coding-agent:** keep fork session id aligned ([8011e20](https://github.com/fleetagent/pi/commit/8011e20932b5da8a1d656341dfac926fa1cbe15e))
* **coding-agent:** keep fork session id aligned ([dce24ac](https://github.com/fleetagent/pi/commit/dce24ac9ff98d4d4df7a7a6129468932f2c50508))
* **coding-agent:** keep pending tool renders after thinking toggle ([755da30](https://github.com/fleetagent/pi/commit/755da309dd3a1115abc7073c061da8229832acb0)), closes [#4167](https://github.com/fleetagent/pi/issues/4167)
* **coding-agent:** list themes by content name ([a93c6a5](https://github.com/fleetagent/pi/commit/a93c6a526624dd611665e9196a32aa46678e4562))
* **coding-agent:** list themes by content name ([088987b](https://github.com/fleetagent/pi/commit/088987b200c214f5ee11b45781b3eee10b7ef6cd))
* **coding-agent:** mark retrying agent end events ([c685b27](https://github.com/fleetagent/pi/commit/c685b2736982eb5c21969870813d075bf36a4ebd))
* **coding-agent:** parse multiline prompt template args ([d0fe857](https://github.com/fleetagent/pi/commit/d0fe8570e93e737c74e30223e91adb4248ac49bc)), closes [#4553](https://github.com/fleetagent/pi/issues/4553)
* **coding-agent:** pin fd for macos x64 ([7afd80d](https://github.com/fleetagent/pi/commit/7afd80d78801cdd5a9be8c0e018d556605d90784)), closes [#4559](https://github.com/fleetagent/pi/issues/4559)
* **coding-agent:** polish border status editor example ([0b271a2](https://github.com/fleetagent/pi/commit/0b271a2c4f539c24d33a6f3e8f8e9e7abe625823)), closes [#3674](https://github.com/fleetagent/pi/issues/3674)
* **coding-agent:** preserve .agents provenance in skill metadata ([dfb9ffa](https://github.com/fleetagent/pi/commit/dfb9ffa9ee4388eb7920cf68ad23a708b91aa5fd))
* **coding-agent:** preserve .agents provenance in skill metadata ([0f95975](https://github.com/fleetagent/pi/commit/0f95975103f0429747698f2da13427928573fcbc)), closes [#3978](https://github.com/fleetagent/pi/issues/3978)
* **coding-agent:** preserve final TUI frame on quit ([6bb4a55](https://github.com/fleetagent/pi/commit/6bb4a555248dc0ebde07b3c7f7ad0e4cf387e5d4))
* **coding-agent:** preserve in-memory settings on reload ([86ba08a](https://github.com/fleetagent/pi/commit/86ba08a2e38fa14a6b42ea6e3f9f3b23976aa6d1)), closes [#3616](https://github.com/fleetagent/pi/issues/3616)
* **coding-agent:** preserve models when re-registering provider with overrides only ([#3651](https://github.com/fleetagent/pi/issues/3651)) ([39a9784](https://github.com/fleetagent/pi/commit/39a9784d2a4fba33e47bf977b4ff9c312daceee2))
* **coding-agent:** prevent wrapped padding in HTML export ([01e2536](https://github.com/fleetagent/pi/commit/01e2536879ebfcfad1a43bc91461849a894d8d7e))
* **coding-agent:** reconcile git package refs ([bf56a86](https://github.com/fleetagent/pi/commit/bf56a86e1e8ab6a57c1299fb9b2ab4adc5265d0b)), closes [#4870](https://github.com/fleetagent/pi/issues/4870)
* **coding-agent:** redo Bun package manager node_modules handling ([#3998](https://github.com/fleetagent/pi/issues/3998)) ([0dd1189](https://github.com/fleetagent/pi/commit/0dd11898ad60c2ad906011ff07ebf7d9970d3281))
* **coding-agent:** refresh thinking border from extensions ([95ae590](https://github.com/fleetagent/pi/commit/95ae59027916702dd11640c93be64ce2d7e7900c)), closes [#3888](https://github.com/fleetagent/pi/issues/3888)
* **coding-agent:** refresh title after extension session rename ([c19e64a](https://github.com/fleetagent/pi/commit/c19e64a444373b558d5d0d44eb4d52877ea07593)), closes [#3686](https://github.com/fleetagent/pi/issues/3686)
* **coding-agent:** remove detached: true on Windows to fix pwsh.exe stdio ([#4013](https://github.com/fleetagent/pi/issues/4013)) ([24dec9f](https://github.com/fleetagent/pi/commit/24dec9fcd531b5be99b0581a1a35899f274b9dc4)), closes [#4012](https://github.com/fleetagent/pi/issues/4012)
...
* **coding-agent:** render compact read calls directly ([324aa1d](https://github.com/fleetagent/pi/commit/324aa1d6477a2c889841a720600983af49a8dc26))
* **coding-agent:** repair self-update detection ([ade08de](https://github.com/fleetagent/pi/commit/ade08de14cfd585fd32c3614d5bd33660fab69f5)), closes [#3942](https://github.com/fleetagent/pi/issues/3942) [#3980](https://github.com/fleetagent/pi/issues/3980) [#3922](https://github.com/fleetagent/pi/issues/3922)
* **coding-agent:** report edit access failures correctly ([#3955](https://github.com/fleetagent/pi/issues/3955)) ([43ee9b7](https://github.com/fleetagent/pi/commit/43ee9b77ed6836860b11eed52e333cd15caa432d))
* **coding-agent:** resolve pnpm global packages ([27a1930](https://github.com/fleetagent/pi/commit/27a193070d73f9beb5a0b08786878cbf6e1a2eea)), closes [#4501](https://github.com/fleetagent/pi/issues/4501)
* **coding-agent:** restore terminal on uncaught exception ([5998b57](https://github.com/fleetagent/pi/commit/5998b579585d62491541ee44ef6451dc8695bb86))
* **coding-agent:** restore terminal on uncaught exception ([9d84e28](https://github.com/fleetagent/pi/commit/9d84e28692f9483eea5a950ca017174cb641867a))
* **coding-agent:** retry Anthropic message_stop stream endings ([5ac874c](https://github.com/fleetagent/pi/commit/5ac874c8495e03c2e2da7751e20d01e707a43e15)), closes [#4433](https://github.com/fleetagent/pi/issues/4433)
* **coding-agent:** route compaction through streamFn ([2ad5890](https://github.com/fleetagent/pi/commit/2ad5890bb555f4984785589a2986d7b4e0a2f3ef))
* **coding-agent:** route compaction through streamFn ([35f807c](https://github.com/fleetagent/pi/commit/35f807cfafbaa63a914e3d9bdbd19dadd5abd1f1)), closes [#4484](https://github.com/fleetagent/pi/issues/4484)
* **coding-agent:** route global fetch through undici dispatcher closes [#4519](https://github.com/fleetagent/pi/issues/4519) ([e26fbb3](https://github.com/fleetagent/pi/commit/e26fbb3d4604d518a39cb16291d4061d4b5146d5))
* **coding-agent:** scroll shared tool entries to rendered tool calls ([7670563](https://github.com/fleetagent/pi/commit/767056337474d1682f34e595eeddb15932d38b2f))
* **coding-agent:** scroll shared tool entries to rendered tool calls ([6424884](https://github.com/fleetagent/pi/commit/64248840f87662c1a1aedf3568209ffde575ab94))
* **coding-agent:** set explicit theme text colors ([4790246](https://github.com/fleetagent/pi/commit/479024603eea9b8e0384fcf718c5b294ae89c8bf))
* **coding-agent:** share theme across package scopes ([f8d0fa6](https://github.com/fleetagent/pi/commit/f8d0fa67dc67669374bf1442c2df9227f848a192)), closes [#4333](https://github.com/fleetagent/pi/issues/4333)
* **coding-agent:** show compact read line ranges ([e355696](https://github.com/fleetagent/pi/commit/e355696d8a6fd65691fb02192a5dfb098fdc5572))
* **coding-agent:** show item count instead of line count in config scroll indicator ([#3820](https://github.com/fleetagent/pi/issues/3820)) ([13610d3](https://github.com/fleetagent/pi/commit/13610d389330e5ed9539876a730560a7397d3407))
* **coding-agent:** show models.json auth in login selector ([39db145](https://github.com/fleetagent/pi/commit/39db1454958859075e34a156657bb9d5863755de))
* **coding-agent:** show Option key on macOS ([91bacac](https://github.com/fleetagent/pi/commit/91bacac739adf16e24a18e5f4f5b2855075c5ab9)), closes [#4289](https://github.com/fleetagent/pi/issues/4289)
* **coding-agent:** simplify agent session settlement ([32bcdc9](https://github.com/fleetagent/pi/commit/32bcdc9739d4b806c209a584c6c81a7a22366482))
* **coding-agent:** skip X11-only native addon for /copy on Linux ([060c10b](https://github.com/fleetagent/pi/commit/060c10b8ffa14aa71ac632b75b90219cb3b77411)), closes [#4177](https://github.com/fleetagent/pi/issues/4177)
* **coding-agent:** space interactive errors ([7ddc7dd](https://github.com/fleetagent/pi/commit/7ddc7dd1ec9b2a32e54f8d23b45b37e5f886510a)), closes [#4510](https://github.com/fleetagent/pi/issues/4510)
* **coding-agent:** spawn Windows npm shims directly ([6b872be](https://github.com/fleetagent/pi/commit/6b872be2b9294dbde57634477bdda96582a5eed3)), closes [#4623](https://github.com/fleetagent/pi/issues/4623)
* **coding-agent:** stop tool argument injection ([3d43d2e](https://github.com/fleetagent/pi/commit/3d43d2e1750f660a523b6ecf2700fdba4dc35571)), closes [#4018](https://github.com/fleetagent/pi/issues/4018)
* **coding-agent:** stream bash output incrementally ([#4165](https://github.com/fleetagent/pi/issues/4165)) ([6b18cdb](https://github.com/fleetagent/pi/commit/6b18cdbac12edb1d6156b1307cb5133fa0ad1a41)), closes [#4145](https://github.com/fleetagent/pi/issues/4145)
* **coding-agent:** strip skill wrapper XML from HTML export user messages ([#4234](https://github.com/fleetagent/pi/issues/4234)) ([8861966](https://github.com/fleetagent/pi/commit/88619669e2fc3efaf2697742608d0fe500ddba9d))
* **coding-agent:** support uppercase context files closes [#3949](https://github.com/fleetagent/pi/issues/3949) ([b79e7f8](https://github.com/fleetagent/pi/commit/b79e7f8058013e8c0c3d35aaae8bead43e63bb37))
* **coding-agent:** tighten HTML export tool spacing ([b8238a7](https://github.com/fleetagent/pi/commit/b8238a77a5ad606624a79a13f4b7dabc36c141f4))
* **coding-agent:** unblock Windows external editor ([a294cda](https://github.com/fleetagent/pi/commit/a294cdafd9731de96b08b30ba42f3cefea9bb650)), closes [#4612](https://github.com/fleetagent/pi/issues/4612)
* **coding-agent:** update agent package readme link ([8632e1b](https://github.com/fleetagent/pi/commit/8632e1b9484b9be62e8fc9b31757176f7c560313)), closes [#4023](https://github.com/fleetagent/pi/issues/4023)
* **coding-agent:** update clipboard dependency ([e91a303](https://github.com/fleetagent/pi/commit/e91a303c59f4395265ec3074e3fb4d95c8892337)), closes [#3946](https://github.com/fleetagent/pi/issues/3946)
* **coding-agent:** update clipboard native package ([bfd6535](https://github.com/fleetagent/pi/commit/bfd6535f7babc2f98d043794e2f705d208b046fb)), closes [#4492](https://github.com/fleetagent/pi/issues/4492)
* **coding-agent:** update provider auth guidance and defaults ([f2f0361](https://github.com/fleetagent/pi/commit/f2f03616ab7f5e0db08b94c4dcd2cce8773615b0))
* **coding-agent:** update sandbox lodash lockfile ([c84cfc7](https://github.com/fleetagent/pi/commit/c84cfc77e6bd99e73a49ea9d8c1850f689d79472)), closes [#3901](https://github.com/fleetagent/pi/issues/3901)
* **coding-agent:** use alternate logic to find Bun's node_modules ([#3861](https://github.com/fleetagent/pi/issues/3861)) ([c241c6d](https://github.com/fleetagent/pi/commit/c241c6d6d0232fdb594b436e95b82f72accfd58f))
* **coding-agent:** use compacted context for handoff ([2fa7c2e](https://github.com/fleetagent/pi/commit/2fa7c2ef2f20d34fb0836c5a58c5e2650b6bc467)), closes [#3945](https://github.com/fleetagent/pi/issues/3945)
* **coding-agent:** use configured model scope cycle hint closes [#4508](https://github.com/fleetagent/pi/issues/4508) ([43d3cdd](https://github.com/fleetagent/pi/commit/43d3cdd48a62809d253e354123b72215f4cb16b4))
* **coding-agent:** use cross-spawn for Windows shims ([6415066](https://github.com/fleetagent/pi/commit/64150668b882f50bf2dc73557e154847f1f9d11f)), closes [#4665](https://github.com/fleetagent/pi/issues/4665)
* **coding-agent:** use the right basedir for patterns ([60e2e43](https://github.com/fleetagent/pi/commit/60e2e4332d98b07f1d07bb32a9dee32dc9327513))
* **coding-agent:** use the right basedir for patterns ([baf4028](https://github.com/fleetagent/pi/commit/baf4028fb97254d359bde48fd1c0a8c27e639a7c))
* **coding-agent:** work around Bun empty process.env inside sandbox ([#3807](https://github.com/fleetagent/pi/issues/3807)) ([cbe421f](https://github.com/fleetagent/pi/commit/cbe421f877fc998977a1f1547cca803e5a42c4b5)), closes [#3806](https://github.com/fleetagent/pi/issues/3806)
...
* honor telemetry for Cloudflare attribution headers ([fbb5eed](https://github.com/fleetagent/pi/commit/fbb5eed1910ecc0af86ec8f56e050f7e6b03479f))
* **package-manager:** ignore managed npm folders in cloud sync ([9fdc54b](https://github.com/fleetagent/pi/commit/9fdc54b6f09a10f7e67aa5c6c465e52981463ee4)), closes [#4763](https://github.com/fleetagent/pi/issues/4763)
* **release:** finalize Windows ARM64 binary support ([0b54c87](https://github.com/fleetagent/pi/commit/0b54c87e24ba94b0a2ac43501959fd35c48deb1b)), closes [#4410](https://github.com/fleetagent/pi/issues/4410)
* update stale CI test expectations ([91154d9](https://github.com/fleetagent/pi/commit/91154d9757c1da8a7b2ba5be4bf025fe58d53114))
...
- **Remote session persistence** - Session managers can persist and load sessions through a remote session backend.
- **Shared GitHub Copilot device-code login flow** - OAuth device-code metadata and polling are shared through `@fleetagent/pi-ai` and surfaced in Pi login flows.
- **SDK `PiAgent` composition root** - SDK session construction is centered around `PiAgent`, with updated examples and multi-session APIs. See [README.md#sdk](README.md#sdk).
...
- Removed non-working OpenAI Codex fast model variants inherited from `@fleetagent/pi-ai`.
...
- **Image generation support** - Added image generation APIs, generated image model metadata, and built-in OpenRouter image generation support inherited from `@fleetagent/pi-ai`.
...
- **Improved terminal and markdown rendering** - Added markdown list indentation, task-list checkbox rendering, large markdown robustness, and inline image placement fixes inherited from `@fleetagent/pi-tui`.

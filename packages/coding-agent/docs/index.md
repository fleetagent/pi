...
For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @fleetagent/pi-coding-agent`, `yarn global remove @fleetagent/pi-coding-agent`, or `bun uninstall -g @fleetagent/pi-coding-agent`.

...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@fleetagent/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@fleetagent/pi-tui";
...
Import from `@fleetagent/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@fleetagent/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@fleetagent/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@fleetagent/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@fleetagent/pi-coding-agent";
import { Markdown } from "@fleetagent/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@fleetagent/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@fleetagent/pi-coding-agent";
import { DynamicBorder } from "@fleetagent/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@fleetagent/pi-tui";
...
For toggling multiple settings. Use `SettingsList` from `@fleetagent/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@fleetagent/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@fleetagent/pi-tui";
...
import { matchesKey, truncateToWidth } from "@fleetagent/pi-tui";

...
|--------|---------|-------------|
| `tui.editor.cursorUp` | `up` | Move cursor up; browse older history when empty or already browsing at the top |
| `tui.editor.cursorDown` | `down` | Move cursor down; browse newer history at the bottom while browsing |

...
npm uninstall -g @fleetagent/pi-coding-agent

# pnpm
pnpm remove -g @fleetagent/pi-coding-agent

# Yarn
yarn global remove @fleetagent/pi-coding-agent

# Bun
bun uninstall -g @fleetagent/pi-coding-agent
```
...
If a directory contains `AGENTS.override.md`, Pi loads it instead of `AGENTS.md` or `CLAUDE.md` from that directory. Other directories continue to layer normally.

...
```bash
npm install @fleetagent/pi-ai
```

TypeBox exports are re-exported from `@fleetagent/pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@fleetagent/pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@fleetagent/pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@fleetagent/pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@fleetagent/pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@fleetagent/pi-ai';
...
```typescript
import { getModel, stream } from '@fleetagent/pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@fleetagent/pi-ai';
...
```typescript
import { Model, stream } from '@fleetagent/pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@fleetagent/pi-ai';
...
```typescript
import { getModel, complete, Context } from '@fleetagent/pi-ai';
...
```typescript
import { Context, getModel, complete } from '@fleetagent/pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@fleetagent/pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@fleetagent/pi-ai';
...
```bash
npx @fleetagent/pi-ai login              # interactive provider selection
npx @fleetagent/pi-ai login anthropic    # login to specific provider
npx @fleetagent/pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@fleetagent/pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
```typescript
import { loginGitHubCopilot } from '@fleetagent/pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@fleetagent/pi-ai';
import { getOAuthApiKey } from '@fleetagent/pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@fleetagent/pi-ai`

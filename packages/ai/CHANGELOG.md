...
* **ai:** add GPT-6 Sol and Luna support ([a342931](https://github.com/fleetagent/pi/commit/a342931dfbc88ccf98215e35846de1f6008b0b13))
...
## [0.2.5](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.2.4...@fleetagent/pi-ai-v0.2.5) (2026-09-17)
...
## [0.2.4](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.2.3...@fleetagent/pi-ai-v0.2.4) (2026-09-12)
...
## [0.1.7](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.1.6...@fleetagent/pi-ai-v0.1.7) (2026-07-13)
...
## [0.1.6](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.1.5...@fleetagent/pi-ai-v0.1.6) (2026-07-13)
...
## [0.1.2](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.1.1...@fleetagent/pi-ai-v0.1.2) (2026-06-13)
...
## [0.1.1](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.1.0...@fleetagent/pi-ai-v0.1.1) (2026-06-12)
...
## [0.1.0](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.0.12...@fleetagent/pi-ai-v0.1.0) (2026-06-12)
...
* **ai:** add Mistral Medium 3.5 model ([#4009](https://github.com/fleetagent/pi/issues/4009)) ([779d0ef](https://github.com/fleetagent/pi/commit/779d0ef39df4a1b5ee68dc06ecc6b3a3f853ea85))
...
* **ai:** expose routed model on openai-completions ([#3968](https://github.com/fleetagent/pi/issues/3968)) ([e354c52](https://github.com/fleetagent/pi/commit/e354c521f435d58407e4488dc97b3a1a06bd8627))
...
* image content ([9751057](https://github.com/fleetagent/pi/commit/9751057be9dea7108317f05762068caf6286d26f))
* image content ([c3c1073](https://github.com/fleetagent/pi/commit/c3c10737d86f76ec61fc46ccc957eda883010d6d))
* image models ([63c61aa](https://github.com/fleetagent/pi/commit/63c61aac6f36815651a54fc01cce33f5042ba667))
* images api types ([e3d066d](https://github.com/fleetagent/pi/commit/e3d066daa0e81ad74185e631dbd8a1c289e34903))
* images registry ([62d9132](https://github.com/fleetagent/pi/commit/62d9132648edb9ccfe1ec49853825ef485af65dd))
* images stream ([e9b0af0](https://github.com/fleetagent/pi/commit/e9b0af0a11c53437e4db0773e706921d63cce0fd))
...
* openrouter images ([d9adc53](https://github.com/fleetagent/pi/commit/d9adc536f5d39f3fd259ff5f047ddd03a33d25e4))


### Bug Fixes

* **ai:** add session affinity and compat fixes for Fireworks provider caching ([cb3c42e](https://github.com/fleetagent/pi/commit/cb3c42ecf5fca135959e63b825aac2d4a23c63f6))
* **ai:** add session affinity and compat fixes for Fireworks provider caching ([99dc6fc](https://github.com/fleetagent/pi/commit/99dc6fcec8cb32aeba0aaf66e21db91bcdbdeb60))
* **ai:** add Xiaomi reasoning replay compat ([b8f5195](https://github.com/fleetagent/pi/commit/b8f51957a045a4716a98f3e760e92ca2c42ae523)), closes [#4678](https://github.com/fleetagent/pi/issues/4678)
* **ai:** align copilot claude adaptive test ([533d373](https://github.com/fleetagent/pi/commit/533d37305c3c189a8f7f82e0919672cf71efdaa6))
* **ai:** apply DeepSeek V4 reasoning compat ([c1dd608](https://github.com/fleetagent/pi/commit/c1dd6082eef4a0b81877c178195decfa22a7d810)), closes [#3940](https://github.com/fleetagent/pi/issues/3940)
* **ai:** bump anthropic sdk for audit ([eb522d6](https://github.com/fleetagent/pi/commit/eb522d6c3cd8e83511572f35d3977f171b65fca7)), closes [#3992](https://github.com/fleetagent/pi/issues/3992)
* **ai:** cap context-sized default output budgets ([6d474f8](https://github.com/fleetagent/pi/commit/6d474f8c1ac09f44f07b22991942c2ab0da6d63e)), closes [#4614](https://github.com/fleetagent/pi/issues/4614)
* **ai:** clamp OpenAI prompt cache keys ([7be75ba](https://github.com/fleetagent/pi/commit/7be75badede41576e0b8a751ac746f048a39357b)), closes [#4720](https://github.com/fleetagent/pi/issues/4720)
* **ai:** correct DeepSeek V4 pricing metadata ([ae81deb](https://github.com/fleetagent/pi/commit/ae81deb4c398f25e50d6b7880bb939e60577e626)), closes [#3910](https://github.com/fleetagent/pi/issues/3910)
* **ai:** detect incomplete Anthropic streams ([83592bb](https://github.com/fleetagent/pi/commit/83592bb2df67a1dacdbeb6c7aefef8ae2ff89ef3)), closes [#3936](https://github.com/fleetagent/pi/issues/3936)
* **ai:** detect litellm context overflow errors ([7c5c3d6](https://github.com/fleetagent/pi/commit/7c5c3d6fd60a0a3d8a3d40d9320c32975b01b215)), closes [#4563](https://github.com/fleetagent/pi/issues/4563)
* **ai:** disable OpenAI reasoning where supported ([783e96a](https://github.com/fleetagent/pi/commit/783e96a14431e9cb33299d8c5e162cc5ad6e7c69))
* **ai:** enable xhigh for DeepSeek V4 Flash ([d23cf31](https://github.com/fleetagent/pi/commit/d23cf316341355f2af175c12a88daa4015f4b3e2)), closes [#3944](https://github.com/fleetagent/pi/issues/3944)
...
* **ai:** fix mismatch between models.dev and OpenCode Go (Qwen3.5/3.6, MiniMax M2.7) ([#4110](https://github.com/fleetagent/pi/issues/4110)) ([05abdd8](https://github.com/fleetagent/pi/commit/05abdd8fdeeffa127c73c07a7417ed1b52639fc3))
* **ai:** fix mismatch between models.dev and OpenCode Go (Qwen3.5/3.6, MiniMax M2.7) ([#4110](https://github.com/fleetagent/pi/issues/4110)) ([c8edb25](https://github.com/fleetagent/pi/commit/c8edb256b9dc20f6fba798e5b90ef304b9e85d10))
* **ai:** handle mixed chat completion deltas ([fa35c5f](https://github.com/fleetagent/pi/commit/fa35c5fabe86a547d86fe3722bb28452b9fecf9e))
* **ai:** handle mixed chat completion deltas ([6b27184](https://github.com/fleetagent/pi/commit/6b271842e27aa00d70003877ae58a197b664681e)), closes [#4228](https://github.com/fleetagent/pi/issues/4228)
* **ai:** handle OpenAI Responses reasoning text deltas ([31f5c23](https://github.com/fleetagent/pi/commit/31f5c23271f26047c615b2170ff9c0d80756fb26))
* **ai:** handle OpenRouter DeepSeek V4 reasoning ([f5b6e4f](https://github.com/fleetagent/pi/commit/f5b6e4fab0a6c325ba57e19c41f1a845ca136a2e)), closes [#4055](https://github.com/fleetagent/pi/issues/4055) [#4047](https://github.com/fleetagent/pi/issues/4047)
...
* **ai:** honor retry-after for OpenAI Codex SSE retries ([0ae9093](https://github.com/fleetagent/pi/commit/0ae909316a9ede121e91d9830b17fe204d376ebd))
* **ai:** ignore generic GitHub tokens for Copilot auth ([a8af0b5](https://github.com/fleetagent/pi/commit/a8af0b5e99e3309c5cbc3301c276302512789ca5)), closes [#4485](https://github.com/fleetagent/pi/issues/4485)
* **ai:** map copilot gpt 5 minimal thinking to low ([6730c04](https://github.com/fleetagent/pi/commit/6730c04a65dd3a18482bd782632f9ae6a618cd17))
* **ai:** map copilot gpt minimal thinking to low ([485afc9](https://github.com/fleetagent/pi/commit/485afc9c3fcf223b908f0bc84233e115911fd125))
* **ai:** mark inception/mercury-2 thinkingLevelMap.off as null ([40c05f5](https://github.com/fleetagent/pi/commit/40c05f55391663024a6a05ad33249b616a04e7a1))
* **ai:** mark inception/mercury-2 thinkingLevelMap.off as null ([e2b69a0](https://github.com/fleetagent/pi/commit/e2b69a0bb1cf6ae7a641f478bfa4cfc9979dd37f))
* **ai:** normalize Bedrock model names for profiles ([ed4bc73](https://github.com/fleetagent/pi/commit/ed4bc730805501b34d248ff0ab300d72b346fcd8))
* **ai:** normalize kimi k2p6 alias to kimi-for-coding closes [#4218](https://github.com/fleetagent/pi/issues/4218) ([ace3fd7](https://github.com/fleetagent/pi/commit/ace3fd7e301baf3bcc9d2de1ddf81533f3161954))
* **ai:** normalize opencode go reasoning replay ([21d80de](https://github.com/fleetagent/pi/commit/21d80deda2b0e97c63adacad4dce683514292229)), closes [#4251](https://github.com/fleetagent/pi/issues/4251)
* **ai:** OpenAI Codex SSE - prefer retry-after for retry timeout over default fallback ([ac75abe](https://github.com/fleetagent/pi/commit/ac75abee43cc2b3ebbaf616b98a5c5a9c51b804d))
* **ai:** openai-completions - throw error on missing finish-reason ([0412f62](https://github.com/fleetagent/pi/commit/0412f62f9ed6c9799e7765e983f434c98738bade))
* **ai:** openai-completions - throw error on missing finish-reason ([98ffad0](https://github.com/fleetagent/pi/commit/98ffad0437c8b4bcbd56244be129899b4cc4e283))
* **ai:** prefix HTTP status codes onto Azure OpenAI and OpenAI Responses error messages so auto-retry fires on 5xx/429 ([52e1387](https://github.com/fleetagent/pi/commit/52e13870a1a5c585603735a590124146462b249f)), closes [#4232](https://github.com/fleetagent/pi/issues/4232)
* **ai:** preserve OpenRouter cached token semantics ([87881ca](https://github.com/fleetagent/pi/commit/87881ca686a49004df7671125626bf9314e60469))
* **ai:** refresh generated model catalog for release ([65fc803](https://github.com/fleetagent/pi/commit/65fc80367111492611a60753d42487644a247d9d))
* **ai:** respect model output token limits ([22a9c48](https://github.com/fleetagent/pi/commit/22a9c484e73506777e8e678913bdd275f00d7951)), closes [#4539](https://github.com/fleetagent/pi/issues/4539)
* **ai:** respect proxy envs in bun's websocket ([f6b6b1f](https://github.com/fleetagent/pi/commit/f6b6b1f052c113863aff121596160c2dd16e490d))
* **ai:** respect proxy envs in bun's websocket ([8c2e3ed](https://github.com/fleetagent/pi/commit/8c2e3eddecb997ac4d110fe39725a27e236d8644)), closes [#4346](https://github.com/fleetagent/pi/issues/4346)
* **ai:** set bedrock claude default max tokens ([11c3da4](https://github.com/fleetagent/pi/commit/11c3da4f74bbd4580fbc8e0ca9caaf038c801655)), closes [#4848](https://github.com/fleetagent/pi/issues/4848)
* **ai:** skip unknown bedrock content blocks ([9e2bfc7](https://github.com/fleetagent/pi/commit/9e2bfc7c40072544e3d364fd76ab2535641398b7)), closes [#4223](https://github.com/fleetagent/pi/issues/4223)
* **ai:** stop Codex OAuth stderr writes ([3029836](https://github.com/fleetagent/pi/commit/3029836894d0f2429e2084d9043db984e92c3f0c)), closes [#4141](https://github.com/fleetagent/pi/issues/4141)
* **ai:** stop defaulting max token request caps ([2787b60](https://github.com/fleetagent/pi/commit/2787b601d7cec86a82541e3c6b876748deca880d)), closes [#4675](https://github.com/fleetagent/pi/issues/4675)
* **ai:** switch xiaomi models to openai completions ([ed3904d](https://github.com/fleetagent/pi/commit/ed3904ddd3c4a8d4afa27ff364df314392137998)), closes [#4505](https://github.com/fleetagent/pi/issues/4505)
* **ai:** track DeepSeek prompt cache hits ([fc3cbed](https://github.com/fleetagent/pi/commit/fc3cbedc6c10655c92369c15878cad4171a3511b)), closes [#3880](https://github.com/fleetagent/pi/issues/3880)
* **ai:** update copilot claude test model ([cf7f2e3](https://github.com/fleetagent/pi/commit/cf7f2e3dbbb514446aa66d71855e9afec4eb2ab4))
* **ai:** update OpenAI Codex model list ([a01cf7a](https://github.com/fleetagent/pi/commit/a01cf7afaeb6a397fdff8742e81f5c847b30c61b))
* **ai:** update OpenAI Codex model list ([1af823b](https://github.com/fleetagent/pi/commit/1af823be9d38efc2004cf7106b7826fd245b17f8))
...
* **ai:** vendor proxy env resolution ([c5831df](https://github.com/fleetagent/pi/commit/c5831df689dd651753c90887d08a4b9e1c0ec7e4)), closes [#4513](https://github.com/fleetagent/pi/issues/4513)
...
* lazy loading ([0e4f845](https://github.com/fleetagent/pi/commit/0e4f845cf4e63a9d7af324bf25c48852cd7d5526))
* modalities from openrouter ([59a89e0](https://github.com/fleetagent/pi/commit/59a89e0c1cb315ee41d33da72f3a407b844191ea))
* no fallback for apiKey ([8fa1194](https://github.com/fleetagent/pi/commit/8fa1194c2322a82ce1215724d3856a3bb5e5d314))
* test (openRouterImageGeneration) ([364ac0f](https://github.com/fleetagent/pi/commit/364ac0f3ab2e115bf5d10ac6918cce3376452a9f))
...
## [0.0.10](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.0.9...@fleetagent/pi-ai-v0.0.10) (2026-06-11)
...
## [0.0.9](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.0.8...@fleetagent/pi-ai-v0.0.9) (2026-06-07)
...
## [0.0.8](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.0.7...@fleetagent/pi-ai-v0.0.8) (2026-06-05)
...
## [0.0.5](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.0.4...@fleetagent/pi-ai-v0.0.5) (2026-05-23)
...
## [0.0.4](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.0.3...@fleetagent/pi-ai-v0.0.4) (2026-05-23)
...
## [0.0.3](https://github.com/fleetagent/pi/compare/@fleetagent/pi-ai-v0.0.2...@fleetagent/pi-ai-v0.0.3) (2026-05-23)
...
* **ai:** clamp OpenAI prompt cache keys ([7be75ba](https://github.com/fleetagent/pi/commit/7be75badede41576e0b8a751ac746f048a39357b)), closes [#4720](https://github.com/fleetagent/pi/issues/4720)
* **ai:** correct DeepSeek V4 pricing metadata ([ae81deb](https://github.com/fleetagent/pi/commit/ae81deb4c398f25e50d6b7880bb939e60577e626)), closes [#3910](https://github.com/fleetagent/pi/issues/3910)
* **ai:** correct gpt-5.5 context metadata ([c96c2fc](https://github.com/fleetagent/pi/commit/c96c2fcd1eaf5c455082773c24d702b0fba14a3c))
* **ai:** detect incomplete Anthropic streams ([83592bb](https://github.com/fleetagent/pi/commit/83592bb2df67a1dacdbeb6c7aefef8ae2ff89ef3)), closes [#3936](https://github.com/fleetagent/pi/issues/3936)
* **ai:** detect litellm context overflow errors ([7c5c3d6](https://github.com/fleetagent/pi/commit/7c5c3d6fd60a0a3d8a3d40d9320c32975b01b215)), closes [#4563](https://github.com/fleetagent/pi/issues/4563)
* **ai:** disable OpenAI reasoning where supported ([783e96a](https://github.com/fleetagent/pi/commit/783e96a14431e9cb33299d8c5e162cc5ad6e7c69))
* **ai:** enable xhigh for DeepSeek V4 Flash ([d23cf31](https://github.com/fleetagent/pi/commit/d23cf316341355f2af175c12a88daa4015f4b3e2)), closes [#3944](https://github.com/fleetagent/pi/issues/3944)
...
* **ai:** fix mismatch between models.dev and OpenCode Go (Qwen3.5/3.6, MiniMax M2.7) ([#4110](https://github.com/fleetagent/pi/issues/4110)) ([05abdd8](https://github.com/fleetagent/pi/commit/05abdd8fdeeffa127c73c07a7417ed1b52639fc3))
* **ai:** fix mismatch between models.dev and OpenCode Go (Qwen3.5/3.6, MiniMax M2.7) ([#4110](https://github.com/fleetagent/pi/issues/4110)) ([c8edb25](https://github.com/fleetagent/pi/commit/c8edb256b9dc20f6fba798e5b90ef304b9e85d10))
* **ai:** forward google vertex base url ([65a6472](https://github.com/fleetagent/pi/commit/65a6472bdd372d3cce51c99830a33f778f0127c7)), closes [#3619](https://github.com/fleetagent/pi/issues/3619)
* **ai:** handle mixed chat completion deltas ([fa35c5f](https://github.com/fleetagent/pi/commit/fa35c5fabe86a547d86fe3722bb28452b9fecf9e))
* **ai:** handle mixed chat completion deltas ([6b27184](https://github.com/fleetagent/pi/commit/6b271842e27aa00d70003877ae58a197b664681e)), closes [#4228](https://github.com/fleetagent/pi/issues/4228)
* **ai:** handle OpenAI Responses reasoning text deltas ([31f5c23](https://github.com/fleetagent/pi/commit/31f5c23271f26047c615b2170ff9c0d80756fb26))
* **ai:** handle OpenRouter DeepSeek V4 reasoning ([f5b6e4f](https://github.com/fleetagent/pi/commit/f5b6e4fab0a6c325ba57e19c41f1a845ca136a2e)), closes [#4055](https://github.com/fleetagent/pi/issues/4055) [#4047](https://github.com/fleetagent/pi/issues/4047)
...
* **ai:** honor retry-after for OpenAI Codex SSE retries ([0ae9093](https://github.com/fleetagent/pi/commit/0ae909316a9ede121e91d9830b17fe204d376ebd))
* **ai:** ignore generic GitHub tokens for Copilot auth ([a8af0b5](https://github.com/fleetagent/pi/commit/a8af0b5e99e3309c5cbc3301c276302512789ca5)), closes [#4485](https://github.com/fleetagent/pi/issues/4485)
* **ai:** ignore unknown anthropic sse events ([3e7ffff](https://github.com/fleetagent/pi/commit/3e7ffff184e805930e23c7440fa9571407a485ee)), closes [#3708](https://github.com/fleetagent/pi/issues/3708)
* **ai:** map copilot gpt 5 minimal thinking to low ([6730c04](https://github.com/fleetagent/pi/commit/6730c04a65dd3a18482bd782632f9ae6a618cd17))
* **ai:** map copilot gpt minimal thinking to low ([485afc9](https://github.com/fleetagent/pi/commit/485afc9c3fcf223b908f0bc84233e115911fd125))
* **ai:** mark inception/mercury-2 thinkingLevelMap.off as null ([40c05f5](https://github.com/fleetagent/pi/commit/40c05f55391663024a6a05ad33249b616a04e7a1))
* **ai:** mark inception/mercury-2 thinkingLevelMap.off as null ([e2b69a0](https://github.com/fleetagent/pi/commit/e2b69a0bb1cf6ae7a641f478bfa4cfc9979dd37f))
...
* **ai:** normalize kimi k2p6 alias to kimi-for-coding closes [#4218](https://github.com/fleetagent/pi/issues/4218) ([ace3fd7](https://github.com/fleetagent/pi/commit/ace3fd7e301baf3bcc9d2de1ddf81533f3161954))
* **ai:** normalize opencode go reasoning replay ([21d80de](https://github.com/fleetagent/pi/commit/21d80deda2b0e97c63adacad4dce683514292229)), closes [#4251](https://github.com/fleetagent/pi/issues/4251)
* **ai:** omit tools field instead of sending empty array ([#3650](https://github.com/fleetagent/pi/issues/3650)) ([3e0ee69](https://github.com/fleetagent/pi/commit/3e0ee69b5ead441e4669b123b2f98635fee7da30)), closes [#3649](https://github.com/fleetagent/pi/issues/3649)
* **ai:** OpenAI Codex SSE - prefer retry-after for retry timeout over default fallback ([ac75abe](https://github.com/fleetagent/pi/commit/ac75abee43cc2b3ebbaf616b98a5c5a9c51b804d))
* **ai:** openai-completions - throw error on missing finish-reason ([0412f62](https://github.com/fleetagent/pi/commit/0412f62f9ed6c9799e7765e983f434c98738bade))
* **ai:** openai-completions - throw error on missing finish-reason ([98ffad0](https://github.com/fleetagent/pi/commit/98ffad0437c8b4bcbd56244be129899b4cc4e283))
* **ai:** prefix HTTP status codes onto Azure OpenAI and OpenAI Responses error messages so auto-retry fires on 5xx/429 ([52e1387](https://github.com/fleetagent/pi/commit/52e13870a1a5c585603735a590124146462b249f)), closes [#4232](https://github.com/fleetagent/pi/issues/4232)
* **ai:** preserve DeepSeek V4 Pro xhigh reasoning ([b4e93fe](https://github.com/fleetagent/pi/commit/b4e93feb8cad641768d0989e23ebef83981557b5)), closes [#3662](https://github.com/fleetagent/pi/issues/3662)
* **ai:** preserve OpenRouter cached token semantics ([87881ca](https://github.com/fleetagent/pi/commit/87881ca686a49004df7671125626bf9314e60469))
* **ai:** refresh generated model catalog for release ([65fc803](https://github.com/fleetagent/pi/commit/65fc80367111492611a60753d42487644a247d9d))
* **ai:** repair codex stream test merge conflict ([95f4921](https://github.com/fleetagent/pi/commit/95f49212506eb21901f6ed0152588ed50aa32132))
* **ai:** replay DeepSeek V4 reasoning content ([9b103e5](https://github.com/fleetagent/pi/commit/9b103e5e41839f379a56acb1b4924064123b3be5)), closes [#3668](https://github.com/fleetagent/pi/issues/3668)
* **ai:** respect model output token limits ([22a9c48](https://github.com/fleetagent/pi/commit/22a9c484e73506777e8e678913bdd275f00d7951)), closes [#4539](https://github.com/fleetagent/pi/issues/4539)
* **ai:** respect proxy envs in bun's websocket ([f6b6b1f](https://github.com/fleetagent/pi/commit/f6b6b1f052c113863aff121596160c2dd16e490d))
* **ai:** respect proxy envs in bun's websocket ([8c2e3ed](https://github.com/fleetagent/pi/commit/8c2e3eddecb997ac4d110fe39725a27e236d8644)), closes [#4346](https://github.com/fleetagent/pi/issues/4346)
* **ai:** set bedrock claude default max tokens ([11c3da4](https://github.com/fleetagent/pi/commit/11c3da4f74bbd4580fbc8e0ca9caaf038c801655)), closes [#4848](https://github.com/fleetagent/pi/issues/4848)
...
* **ai:** use Xiaomi Token Plan Anthropic endpoint ([c0e0469](https://github.com/fleetagent/pi/commit/c0e046990e0b8bada9f3f2c1b665436820589d9f)), closes [#3912](https://github.com/fleetagent/pi/issues/3912)
* **ai:** vendor proxy env resolution ([c5831df](https://github.com/fleetagent/pi/commit/c5831df689dd651753c90887d08a4b9e1c0ec7e4)), closes [#4513](https://github.com/fleetagent/pi/issues/4513)
* **bedrock:** check model.name for prompt caching and adaptive thinking ([#3527](https://github.com/fleetagent/pi/issues/3527)) ([5a07d94](https://github.com/fleetagent/pi/commit/5a07d946ef983e11ead2636f7a81c3a4c07a568c)), closes [#2925](https://github.com/fleetagent/pi/issues/2925)
* **ci:** repair failing test expectations ([e1433cf](https://github.com/fleetagent/pi/commit/e1433cf65b0a7a0d769bf6017b554a300c41fe1a))
* **ci:** repair failing test expectations ([b9efafc](https://github.com/fleetagent/pi/commit/b9efafc5351a746108adb9b135564c574f8f8cfd))
* **coding-agent,ai:** fallback to /proc/self/environ in Bun sandbox ([#3801](https://github.com/fleetagent/pi/issues/3801)) ([5b8deef](https://github.com/fleetagent/pi/commit/5b8deef2f9d255aa682ed99f1b8f100b6e11340c))
* **coding-agent:** decouple codex session cleanup ([2342001](https://github.com/fleetagent/pi/commit/23420012abd670e7ff74dd47c8a81103ca97c0a9))
